/**
 * Config.js - Конфигурация приложения (UPDATED)
 * Содержит настройки Firebase, Cloudinary и константы.
 *
 * Новое:
 * - carStatuses: статусы авто в разборе (для коллекции cars)
 * - receipt: настройки печати (companyName/logoUrl/notes)
 * - inventoryDefaults: дефолты по скидке
 */
...
const Config = {
  ...
  cloudinary: {
    cloudName: "dewtwmiup",
    uploadPreset: "autoparts_unsigned",
    folder: "autoparts"
  },
  ...
  // ==========================================
  // NEW: Cars collection settings
  // ==========================================
  carStatuses: {
    active: { label: "В разборе", class: "active" },
    archived: { label: "Архив", class: "cancelled" }
  },
  ...
  // ==========================================
  // NEW: Receipt settings (опционально)
  // ==========================================
  receipt: {
    companyName: "AutoParts",
    // Если есть логотип — вставь URL:
    // logoUrl: "https://.../logo.png",
    logoUrl: "",
    bookingFooterNote: "Бронь создана. Пожалуйста, дождитесь подтверждения.",
    saleFooterNote: "Спасибо за покупку!"
  },
  ...
  // Статусы заказов (используются в UI/Reservations/Admin)
  orderStatuses: {
...
Object.freeze(Config.carStatuses);
Object.freeze(Config.inventoryDefaults);
Object.freeze(Config.receipt);